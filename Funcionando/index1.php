...
?>
        <td><a href="index1.php" title="Ir a Universidad De Guadalajara"><img id="user" src="usuario.png" alt="GIF" ><a href ="cerrarsesion.php"><img id='cerrarsesion' title='Salir del Sistema' src='cerrarsesion.png'>
</a></a>
   </td>
      </tr>
</table>
